          ...
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex flex-col-reverse items-start gap-2">
              <Input
                ...
                onBlur={e =>
                  handlePriceRange(parseInt(e.target.value), maxPrice)
                }
              />
              <p className="peer text-neutral-500 peer-focus:text-black">
                From
              </p>
            </div>
            <div className="flex flex-col-reverse items-end gap-2">
              <Input
                ...
                onBlur={e =>
                  handlePriceRange(minPrice, parseInt(e.target.value))
                }
              />
